        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-6 col-md-auto"><a href="<?php echo e(route('item.index')); ?>" class="nav-link">Item
                            List</a></li>
                </ul>
...
<?php /**PATH E:\Xampp\htdocs\Zaky-Naufal - Copy\resources\views/profile.blade.php ENDPATH**/ ?>
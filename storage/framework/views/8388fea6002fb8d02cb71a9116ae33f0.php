                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="satuanBarang" id="satuanBarang"
                                value="" placeholder="Enter Item Unit">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<?php /**PATH E:\Xampp\htdocs\Zaky-Naufal\resources\views/item/create.blade.php ENDPATH**/ ?>